...
Below, I have made a two-panel plot showing (i) tmax vs tmin for the full dataset and (ii) a density plot showing the distribution of snowfall values greater than 0 and less than 100 separately by year.The plots demonstrate that snowfall was less than 40 centimeters in most years.
